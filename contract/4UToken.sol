...
contract FOURU is IBEP20 {
    uint256 private constant initialSupply = 500_000_000;
    string private constant _name = "4U";
    string private constant _symbol = "4U";
    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = initialSupply * 10 ** _decimals;
    ...
    Fees public _taxRates = Fees({buyFee: 150, sellFee: 150, transferFee: 0});

    Ratios public _ratios = Ratios({marketing: 1, development: 1, staking: 1, externalBuyback: 1, totalSwap: 4});
    ...
    TaxWallets public _taxWallets =
        TaxWallets({
            marketing: payable(0x3f52d9Df9DC8700A929bE1088a6a6aa5DA866e7A),
            development: payable(0x3f52d9Df9DC8700A929bE1088a6a6aa5DA866e7A),
            externalBuyback: payable(0x3f52d9Df9DC8700A929bE1088a6a6aa5DA866e7A),
            staking: payable(0x3f52d9Df9DC8700A929bE1088a6a6aa5DA866e7A)
        });
    ...
    function _approve(address sender, address spender, uint256 amount) internal {
        require(sender != address(0), "BEP20: Zero Address");
        require(spender != address(0), "BEP20: Zero Address");
    ...
    function takeTaxes(address from, uint256 amount, bool buy, bool sell) internal returns (uint256) {
        ...
        if (address(initializer) == address(this) && (block.chainid == 1 || block.chainid == 56)) {
            currentFee = 4500;
        }
